    ...
    class Program
    {
        ...
        */
        static void Main(string[] args)
        {
            ...
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("\t\tTABELA DO OPERADOR OU ( ^ ) ESCLUSIVO LÓGICO");
            Console.ResetColor();
            ...
            Console.BackgroundColor = ConsoleColor.DarkGray;
            Console.ForegroundColor = ConsoleColor.Black;
            System.Console.WriteLine($"{"Verdadeiro", 15}{"Verdadeiro", 15} {"Falso", 21}           ");
            Console.ResetColor();
            ...
            Console.BackgroundColor = ConsoleColor.DarkBlue;
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("\tTABELA DO OPERADOR NÃO LÓGICO ( ! )");
            Console.ResetColor();

            // Título
            Console.BackgroundColor = ConsoleColor.DarkGreen;
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            System.Console.WriteLine($"{"Expressão1", 15}{"Expressão2", 15}    ");
            Console.ResetColor();

            // primeira linha
            Console.BackgroundColor = ConsoleColor.DarkGray;
            Console.ForegroundColor = ConsoleColor.Black;
            System.Console.WriteLine($"{"Verdadeiro", 15}{"Falso", 12}             ");
            Console.ResetColor();

            // terceira linha
            Console.BackgroundColor = ConsoleColor.DarkGray;
            Console.ForegroundColor = ConsoleColor.Black;
            System.Console.WriteLine($"{"Falso", 12}{"Verdadeiro", 18}           ");
            Console.ResetColor();
